...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProgramaExterno.nombre'
        db.alter_column('captura_programaexterno', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'ProgramaExterno.nombre'
        db.alter_column('captura_programaexterno', 'nombre', self.gf('django.db.models.fields.TextField')())
