...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Documento.universidad' to match new field type.
        db.rename_column('captura_documento', 'universidad', 'universidad_id')
        # Changing field 'Documento.universidad'
        db.alter_column('captura_documento', 'universidad_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['captura.Universidad']))
        # Adding index on 'Documento', fields ['universidad']
        db.create_index('captura_documento', ['universidad_id'])


    def backwards(self, orm):
        # Removing index on 'Documento', fields ['universidad']
        db.delete_index('captura_documento', ['universidad_id'])


        # Renaming column for 'Documento.universidad' to match new field type.
        db.rename_column('captura_documento', 'universidad_id', 'universidad')
        # Changing field 'Documento.universidad'
        db.alter_column('captura_documento', 'universidad', self.gf('django.db.models.fields.CharField')(max_length=200))
