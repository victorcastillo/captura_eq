...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DetalleDocumento.materia_utel'
        db.alter_column('captura_detalledocumento', 'materia_utel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['captura.Cat_Asignatura']))

        # Changing field 'LogDetalleDocto.log_materia_utel'
        db.alter_column('captura_logdetalledocto', 'log_materia_utel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['captura.Cat_Asignatura']))

    def backwards(self, orm):

        # Changing field 'DetalleDocumento.materia_utel'
        db.alter_column('captura_detalledocumento', 'materia_utel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['captura.Asignatura_Licenciatura']))

        # Changing field 'LogDetalleDocto.log_materia_utel'
        db.alter_column('captura_logdetalledocto', 'log_materia_utel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['captura.Asignatura_Licenciatura']))
