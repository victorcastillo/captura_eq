...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocumentosIdsPronostico'
        db.create_table('captura_documentosidspronostico', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('id_doc', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('captura', ['DocumentosIdsPronostico'])

        # Adding field 'DetalleDocumento.eliminado'
        db.add_column('captura_detalledocumento', 'eliminado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DocumentosIdsPronostico'
        db.delete_table('captura_documentosidspronostico')

        # Deleting field 'DetalleDocumento.eliminado'
        db.delete_column('captura_detalledocumento', 'eliminado')
