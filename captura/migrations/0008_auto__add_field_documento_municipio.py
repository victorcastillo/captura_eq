...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Documento.municipio'
        db.add_column('captura_documento', 'municipio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['captura.Municipio']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Documento.municipio'
        db.delete_column('captura_documento', 'municipio_id')
