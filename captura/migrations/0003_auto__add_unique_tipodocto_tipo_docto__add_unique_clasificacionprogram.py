...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TipoDocto', fields ['tipo_docto']
        db.create_unique('captura_tipodocto', ['tipo_docto'])

        # Adding unique constraint on 'ClasificacionPrograma', fields ['clasificacion']
        db.create_unique('captura_clasificacionprograma', ['clasificacion'])

        # Adding unique constraint on 'MateriaExterna', fields ['nombre']
        db.create_unique('captura_materiaexterna', ['nombre'])


    def backwards(self, orm):
        # Removing unique constraint on 'MateriaExterna', fields ['nombre']
        db.delete_unique('captura_materiaexterna', ['nombre'])

        # Removing unique constraint on 'ClasificacionPrograma', fields ['clasificacion']
        db.delete_unique('captura_clasificacionprograma', ['clasificacion'])

        # Removing unique constraint on 'TipoDocto', fields ['tipo_docto']
        db.delete_unique('captura_tipodocto', ['tipo_docto'])
    ...
    models = {
        ...
        'captura.materiaexterna': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.TextField', [], {'unique': 'True'})
        },
        'captura.modalidad': {
