...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LogDocto.log_capturista'
        db.delete_column('captura_logdocto', 'log_capturista_id')

        # Adding field 'LogDocto.usuario'
        db.add_column('captura_logdocto', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'MateriaExterna.nombre'
        db.alter_column('captura_materiaexterna', 'nombre', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))
        # Adding field 'LogDetalleDocto.usuario'
        db.add_column('captura_logdetalledocto', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LogDocto.log_capturista'
        db.add_column('captura_logdocto', 'log_capturista',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'LogDocto.usuario'
        db.delete_column('captura_logdocto', 'usuario_id')


        # Changing field 'MateriaExterna.nombre'
        db.alter_column('captura_materiaexterna', 'nombre', self.gf('django.db.models.fields.TextField')(unique=True))
        # Deleting field 'LogDetalleDocto.usuario'
        db.delete_column('captura_logdetalledocto', 'usuario_id')
