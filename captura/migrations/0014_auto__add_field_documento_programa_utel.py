...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Documento.programa_utel'
        db.add_column('captura_documento', 'programa_utel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['captura.Licenciatura'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Documento.programa_utel'
        db.delete_column('captura_documento', 'programa_utel_id')
