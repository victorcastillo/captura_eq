...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Documento.numero_materias'
        db.add_column('captura_documento', 'numero_materias',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Documento.numero_materias'
        db.delete_column('captura_documento', 'numero_materias')
