...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogDocto.log_programa_utel'
        db.add_column('captura_logdocto', 'log_programa_utel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['captura.Licenciatura'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogDocto.log_programa_utel'
        db.delete_column('captura_logdocto', 'log_programa_utel_id')
    ...
    models = {
        ...
        'captura.documento': {
            ...
            'numero_materias': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'programa_externo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['captura.ProgramaExterno']"}),
            'programa_utel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['captura.Licenciatura']", 'null': 'True'}),
            'tipo_docto': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['captura.TipoDocto']"}),
            'universidad': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['captura.Universidad']"})
        },
        'captura.documentosidspronostico': {
            'Meta': {'object_name': 'DocumentosIdsPronostico'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_doc': ('django.db.models.fields.IntegerField', [], {})
        },
        'captura.entidad': {
        ...
        'captura.logdocto': {
            ...
            'log_programa_utel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['captura.Licenciatura']", 'null': 'True'}),
